export class templates {
    async buyerEmail(quantity, tokenName, walletAddress, brandName, email, mobileNumber, storeAddress) {
        let sendHtml = `<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
                                        ...
                                        <tr>
                                          <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                            <img align="center" border="0"
                                              src="https://newchatmodule.s3.us-east-2.amazonaws.com/uploads/16508684661081650868466096_HovR.png"
                              ...
                              <tbody>
                                <tr>
                                  <td
                                    ...
                                    align="left">
                                    <div
                                      style="color: #1b262c; line-height: 140%; text-align: left; word-wrap: break-word;">
                                      <br>
                                      <br>
                                      <p style="font-size: 14px; line-height: 140%;"> <b>Purchase successfully.</b> <br> <br>
                                      Congratulations  Your just bought ${quantity} ${tokenName} NFT from ${walletAddress}.<br/> <div style="padding-top:10px"/> Your brand details <br/> Brand Name:- ${brandName} <br/>  Email:- ${email} <br/>  Phone No.:- ${mobileNumber} <br/>  Address:- ${storeAddress}  </br>
    ...
    async sellerEmail(quantity, tokenName, walletAddress, userWalletAddress, buyerEmail, mobileNumber, address) {
        let htmlContent = `<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
        xmlns:o="urn:schemas-microsoft-com:office:office">
                                ...
                                <tr>
                                  <td
                                    ...
                                    <div
                                      ...
                                      <br>
                                      <br>
                                      <p style="font-size: 14px; line-height: 140%;"> <b>Congrats your NFT has been sold!!</b> <br> <Br>
                                      Congratulations  Your NFT ${quantity} ${tokenName} has been sold to ${walletAddress}. <br/> <div style="padding-top:10px"/> Your buyer details <br/> Buyer Name:- ${userWalletAddress} <br/>   Email:- ${buyerEmail} <br/>  Phone No.:- ${mobileNumber} <br/>  Address:- ${address}  </br >
    ...
    async dispatched(userName, link) {
                                ...
                                <tr>
                                  <td
                                    ...
                                    <div
                                      ...
                                      <br>
                                      <br>
                                      <p style="font-size: 14px; line-height: 140%;"> <b> Your NFT order has been dispatched!!</b> <br> <Br>
                                          Dear User ${userName} your order has been dispatched please use the link below to check the status. <br/> <div style="padding-top:10px"/> <a href="${link}" target="_blank">${link}</a> 
    ...
    async shipping(userName ,shippingId, companyName) {
        let html = `<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
        xmlns:o="urn:schemas-microsoft-com:office:office">
                                ...
                                <tr>
                                  <td
                                    ...
                                    <div
                                      ...
                                      <br>
                                      <br>
                                      <p style="font-size: 14px; line-height: 140%;"> <b> Your NFT order has been shipped!!</b> <br> <Br>
                                          Dear User ${userName}, Your order has been shipped successfully please find your shipping details below.<br><br>Shipping Id:- ${shippingId}<br/>Shipping Company Name:- ${companyName} <br/> <div style="padding-top:10px"/>
                                     </br >
    <p>Thanks and Regards, <br>
        <b>hovr.site</b>
    </p>
                                ...
                                <tr>
                                  <td
                                    ...
                                    <div
                                      ...
                                      <br>
                                      <br>
                                      <p style="font-size: 14px; line-height: 140%;"> <b> Your NFT order delivered sucessfully!!</b> <br> <Br> Dear User ${userName} your order has marked as delivered by seller. Please confirm your order mark as complete from the link below.<br><br><a href="${link}" target="_blank">${link}</a><div style="padding-top:10px"/>
                                     </br >
    <p>Thanks and Regards, <br>
        <b>hovr.site</b>
    </p>
